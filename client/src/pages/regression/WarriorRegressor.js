...
const WarriorRegressor = () => {
  ...
  const setup = (p5, canvasParentRef) => {
    ...
    const modelInfo = {
      model: 'model_warrior/model.json',
      metadata: 'model_warrior/model_meta.json',
      weights: 'model_warrior/model.weights.bin',
    };
...
export default WarriorRegressor;
